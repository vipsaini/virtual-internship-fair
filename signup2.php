...
if(isset($_POST["u"])){
	...
	// END FORM DATA ERROR HANDLING
		...
		$sql = "INSERT INTO users (username, email, password, gender, country, ip, signup, lastlogin, notescheck, company)       
		        VALUES('$u','$e','$p_hash','$g','$c','$ip',now(),now(),now(), '1')";
		$query = mysqli_query($db_conx, $sql); 
...
function checkusername(){
	...
	if(u != ""){
		...
		var ajax = ajaxObj("POST", "signup2.php");
...
function signup(){
	...
	if(u == "" || e == "" || p1 == "" || p2 == "" || c == "" || g == ""){
		...
		status.innerHTML = 'please wait while we activate your account...';
		var ajax = ajaxObj("POST", "signup2.php");
        ajax.onreadystatechange = function() {
	        if(ajaxReturn(ajax) == true) {
