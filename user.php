...
if($avatar == NULL){
	$profile_pic = '<img src="images/avatardefault.jpg" alt="'.$u.'">'; // correction made
}
?><?php
$isFriend = false;
...
<style type="text/css">
div#profile_pic_box{float:right; border:#999 2px solid; width:200px; height:200px; margin:20px 12px 0px 0px; overflow-y:hidden;}
...
<style type="text/css">
textarea#statustext{width:970px; height:80px; padding:8px; border:#999 1px solid; font-size:16px;}
...
textarea.replytext{width:96.5%; height:15px; padding:1%; border:#999 1px solid;}
...
<div id="pageMiddle">
  ...
  <div id="photo_showcase" onclick="window.location = 'photos.php?u=<?php echo $u; ?>';" title="view <?php echo $u; ?>&#39;s Profile and CV">
    <?php echo $coverpic; ?>
  </div>
  <h2><?php echo $u; ?></h2>
