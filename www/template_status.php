...
$statuslist = "";
if($isOwner == "yes"){
	$status_ui = '<textarea id="statustext" onkeyup="statusMax(this,250)" placeholder="Ok '.$u.', you can also post your work requirements here to let everyone know your need."></textarea>';
	...
	$status_ui = '<textarea id="statustext" onkeyup="statusMax(this,250)" placeholder="Hi '.$log_username.' write something here, only '.$u.' could read your message."></textarea>';
...
$sql = "SELECT * FROM status WHERE type='a' OR account_name='$u' AND type='c' ORDER BY postdate DESC LIMIT 20";
